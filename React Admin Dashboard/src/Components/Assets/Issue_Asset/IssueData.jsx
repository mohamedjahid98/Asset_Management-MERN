      ...
      <main className='main-container'>
        <div className="card-box-emp">
          ...
          <DataTable value={issues} showGridlines filters={filters} globalFilterFields={['empId','empname', 'asset_type', 'issue_date', 'ret_date', 'reason']} stripedRows paginator rows={5} rowsPerPageOptions={[2, 5, 10]} tableStyle={{ minWidth: '50rem' }}
            ...
            <Column field="empsname" filterField="empsname" header="Employee Name"></Column>
            <Column field="asset_type" filterField="asset_type" header="Asset Type"></Column>
            <Column field="issue_date" filterField="issue_date" header="Issue Date"></Column>
            <Column field="ret_date" filterField="ret_date" header="Return Date"></Column>
            <Column field="reason" filterField="reason" header="Reason"></Column>
          </DataTable>
        </div>
      </main>
    </div>

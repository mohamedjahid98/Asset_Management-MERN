...
const AssetsData = () => {
  ...
  const actionTemplate = (rowData) => {
    return (
      <div>
        <Link to={`/assets-manager/update/${rowData._id}`}>
      ...
      <main className='main-container'>
        <div className="card-box-emp">
          ...
          <DataTable value={assets} showGridlines filters={filters} globalFilterFields={['serial_no', 'asset_type', 'make', 'model', 'purchase_date','purchase_cost']} stripedRows paginator rows={5} rowsPerPageOptions={[2, 5, 10]} tableStyle={{ minWidth: '50rem' }}
            ...
            <Column field="serial_no" filterField="serial_no" header="Serial Number"></Column>
            <Column field="asset_type" filterField="asset_type" header="Asset Type"></Column>
            <Column field="make" filterField="make" header="Make"></Column>
